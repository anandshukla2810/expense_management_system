        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{ route( 'vendors.store' ) }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter store name">
                        @error('name')
