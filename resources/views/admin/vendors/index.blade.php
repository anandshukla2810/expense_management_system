                ...
                <div class="card">
                                ...
                                <tbody>
                                    @foreach($vendors as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a class="btn btn-outline-dark btn-sm me-1" href="{{ route( 'vendors.edit', $value->id ) }}">
                    ...
                    @if ($vendors->total() > 0)
                        <div class="card-footer">
                            @if ($vendors->total() <= 5)
                                Showing <b>{{ $vendors->total() }}</b> of <b>{{ $vendors->total() }}</b> result(s)
                            @else
                                {{ $vendors->links() }}
                            @endif
                        </div>
        ...
        $('.delete-button').click(function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ url('admin/vendors/delete') }}/" + id;
