                ...
                @if (Route::has('login'))
                  @auth
                    @if(auth()->user()->usertype == 'admin')
                      ...
                      @elseif(auth()->user()->usertype == 'school_admin')
                      <a class="btn btn-primary" href="{{ url('/school/dashboard') }}">My Account</a>
                      @elseif(auth()->user()->usertype == 'teacher')
                      <a class="btn btn-primary" href="{{ url('/teacher/dashboard') }}">My Account</a>
                      @elseif(auth()->user()->usertype == 'student')
                      <a class="btn btn-primary" href="{{ url('/student/dashboard') }}">My Account</a>
                    @endif
                    @else
